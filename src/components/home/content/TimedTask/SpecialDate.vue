<template>
  <div class="main clearfix">
    ...
    <div class="btn-block">
      <button class="btn">
        <i class="iconfont icon-tianjia"></i>删除
      </button>
      <button class="btn">
    ...
    <table>
      <thead>
        <tr>
          <th v-for="(item,index) of week" :key="index">{{item}}</th>
        </tr>
      </thead>
      <tbody>
        <tr>
...
.main {
  ...
  table {
    ...
    @include trbl(48px, 0, 0, 0);
    background: rgba(0, 0, 0, .15);
    border: 1px solid rgba(255, 255, 225, .15); // width: 100%;
    width: 100%;
    text-align: left;
    white-space: nowrap;
